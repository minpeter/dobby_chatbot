...
# print("좋습니다! 도비랑 게임 하나 하시죠..!") # main.py로 이동!


# p_rsp = input("가위, 바위, 보 중 하나를 입력 (끝내려면 '종료' ): ")
# d_rsp = random.choice(["가위", "바위", "보"])

# if p_rsp == '종료':
#     print('그만..하고싶으시군요!\n')

# elif (p_rsp=='가위' and d_rsp=='보') or (p_rsp=='바위' and d_rsp =='가위') or(p_rsp=='보' and d_rsp=='바위') :
#     print('당신 : '+p_rsp+', 도비 : '+d_rsp+', 주인님의 승리입니다..! 역시 그럴 줄 알았어요..!\n')
# elif (p_rsp=='가위' and d_rsp=='가위') or (p_rsp=='바위' and d_rsp =='바위') or(p_rsp=='보' and d_rsp=='보') :
#     print('당신 : '+p_rsp+', 도비 : '+d_rsp+', 이런..! 주인님이랑 비겨버렸네요..\n')
# elif (p_rsp=='가위' and d_rsp=='바위') or (p_rsp=='바위' and d_rsp =='보') or(p_rsp=='보' and d_rsp=='가위') :
#     print('당신 : '+p_rsp+', 도비 : '+d_rsp+', 도비가!! 도비가 이겼어요!!\n')
# else:
#     print('다시 한번 입력해 주세요..!.\n')
